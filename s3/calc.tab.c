...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_NUM = 3,                        /* NUM  */
  YYSYMBOL_LETTERS = 4,                    /* LETTERS  */
  YYSYMBOL_FLOTANTE = 5,                   /* FLOTANTE  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "NUM", "LETTERS",
  "FLOTANTE", "ENTERO", "'\\n'", "'+'", "'-'", "'*'", "'/'", "'n'",

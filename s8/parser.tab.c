...
{
       0,   135,   135,   136,   140,   141,   142,   143,   146
};
#endif
...
static const char *const yytname[] =
{
  ...
  "PRINT", "'('", "')'", "'='", "';'", "'+'", "$accept", "program", "expr", YY_NULLPTR
};
...
{
       1,     6,     2,     3,     1,     7,     2,     3,     9,    11,
      14,     9,    13,     8,    12,    15,     9,    10
};

static const yytype_int8 yycheck[] =
{
       3,     9,     5,     6,     3,     7,     5,     6,    11,     6,
      10,    11,     9,     0,     5,     8,    11,     5
};
...
#line 1187 "parser.tab.c"
  ...
  case 5: /* expr: ID  */
#line 141 "parser.y"
                       { (yyval.num) = hashtable_get(ht, strdup((yyvsp[0].str))); }
#line 1193 "parser.tab.c"
    break;

  case 6: /* expr: PRINT '(' ID ')'  */
#line 142 "parser.y"
                       { printf("the variable %s: %d: ", (yyvsp[-1].str) ,hashtable_get(ht, strdup((yyvsp[-1].str)))); }
...
#line 143 "parser.y"
                       { 
        hashtable_put(ht, strdup((yyvsp[-3].str)), (yyvsp[-1].num));
    }
